...
(** generates a new symbol with given name *)
val symbol : string -> t 

(** generates a unique symbol from a possibly non-unique name *)
val unique_symbol : string -> t 

(** Returns a name associated with symbol.
   Names of symbols created by unique_symbol will not
   be the same as the give name *)
val name : t -> string 
