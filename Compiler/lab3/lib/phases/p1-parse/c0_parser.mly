...
fdefn :
  | typ = ret_type;
    ...
    params = param_list;
    body = block;
      { Ast.Fdefn (typ, ident, params, body) }
...
typedef :
  | Typedef; typ = typ; ident = Ident; Semicolon;
      { Ast.Typedef (typ, ident) }
