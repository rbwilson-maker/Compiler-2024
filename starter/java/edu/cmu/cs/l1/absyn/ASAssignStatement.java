...
public
class ASAssignStatement extends ASStatement {
   ...
   */
 public
  ASAssignStatement(int p, ASLval v, ASExpression e) {
    super(p);
    m_var = v;
    m_exp = e;
  ...
  /** Return the variable */
 public
  ASLval getVariable() { return m_var; }

  /** Return the expression */
 public
  ASExpression getExpression() { return m_exp; }
