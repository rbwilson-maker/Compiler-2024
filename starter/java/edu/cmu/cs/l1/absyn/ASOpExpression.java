...
public
class ASOpExpression extends ASExpression {
   ...
   */
 public
  ASOpExpression(int p, int oper, ASExpression left, ASExpression right) {
    super(p);
    m_oper = oper;
    m_left = left;
    m_right = right;
  ...
  // Operator classes
 public
  static final int ARITH = 0;

  // Arith
 public
  final static int PLUS = 0, MINUS = 1, MUL = 2, DIV = 3, MOD = 4, NEG = 5;

  /** Return the left side of the expression */
 public
  ASExpression getLeft() { return m_left; }

  /** Return the right side of the expression */
 public
  ASExpression getRight() { return m_right; }

  /** Return the operator */
 public
  int getOperator() { return m_oper; }
