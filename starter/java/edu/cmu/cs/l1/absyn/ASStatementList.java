...
public
class ASStatementList extends ASStatement {
  /** Construct a blank statement list
   * @param p Position in source
   */
 public
  ASStatementList(int p) {
    super(p);
   ...
   */
 public
  ASStatementList(int p, ASStatement d) {
    super(p);
    m_decs.addElement(d);
 ...
 public
   ...
   */
 public
  ASStatementList append(ASStatement d) {
 ...
 public
   ...
   */
 public
  ASStatementList join(ASStatementList d) {
    int i;
    ASStatementList dl = new ASStatementList(m_pos);
