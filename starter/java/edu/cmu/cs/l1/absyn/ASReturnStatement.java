...
public
class ASReturnStatement extends ASStatement {
   ...
   */
 public
  ASReturnStatement(int p, ASExpression rexp) {
    super(p);
    m_rexp = rexp;
 ...
 public
  ASExpression getReturnExpression() { return m_rexp; }

  /** Does the return statement even have an expression? */
 public
  boolean hasReturnExpression() { return (m_rexp != null); }
