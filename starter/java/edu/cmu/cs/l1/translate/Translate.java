...
public
abstract class Translate implements Visitor {
 public
  Translate(ErrorMsg errormsg, TranslateEnvironment table) {
    m_errorMsg = errormsg;
    m_table = table;
  }

 protected
  IRExpression allocInitExp() throws TranslateException {
