...
public
class IRPrint implements Visitor {
  java.io.PrintStream out;
  TempMap tmap;

 public
  IRPrint(java.io.PrintStream o, TempMap t) {
    out = o;
    tmap = t;
    indentLevel = 0;
  }
 ...
 public
  IRPrint(java.io.PrintStream o) { this(o, new DefaultMap()); }
 ...
 private
  void visitConst(Object e) {
    ...
    indentLevel++;
    indent();
    sayln(String.valueOf(ie.getValue()));
    indentLevel--;
    indent();
    sayln(")");
  }
