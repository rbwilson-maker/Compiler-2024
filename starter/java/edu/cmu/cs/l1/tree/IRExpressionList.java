...
public
class IRExpressionList extends IRExpression {
 public
  IRExpressionList() {
    m_exps = new Vector();
 ...
 public
  IRExpressionList(IRExpression e) {
    m_exps.addElement(e);
 ...
 public
  IRExpressionList(IRExpression e, IRExpressionList ee) {
    m_exps.addElement(e);
    if (ee != null) {
 ...
 public
  IRExpressionList(IRExpressionList l) {
 ...
 public
  IRExpression getExpression(int index) {
    return (IRExpression)m_exps.elementAt(index);
  }

 public
  IRExpressionList prepend(IRExpression e) {
    int i;
 ...
 public
  IRExpressionList append(IRExpression e) {
 ...
 public
  IRExpressionList join(IRExpressionList l) {
    int i;
    IRExpressionList nl = new IRExpressionList();
